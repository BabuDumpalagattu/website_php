...
// import { MapPin, Clock, DollarSign, Building, IndianRupeeIcon } from "lucide-react";
...
// //           <span className="text-sm">{job.salary.replace('-', ' – ')} LPA</span>
// //         </div>
...
import { Building, MapPin, Clock, IndianRupeeIcon } from "lucide-react";
import { Card, CardContent, CardHeader } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { Button } from "@/components/ui/button";
import { Job } from "@/types/job";
  ...
  return (
    <Card className="hover:shadow-lg transition-shadow duration-300 border border-gray-200">
      ...
      <CardContent className="pt-0">
        ...
        {/* <div className="text-gray-700 text-sm mb-4 line-clamp-2 whitespace-pre-line">{job.description}</div> */}
